  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(children: [
        ...
        Row(
          ...
          children: [
            CircularPercentIndicator(
              ...
              center: Text(
                  (widget.waterDrunkGoal!/widget.totalWaterGoal!*100).round()>100?'100%':'${(widget.waterDrunkGoal!/widget.totalWaterGoal!*100).round()}%',
            ...
            Column(
              ...
              children: [
                Row(
                  children: [
                    Text(
                      (widget.waterDrunkGoal!/widget.totalWaterGoal!*100).round()>100?'${widget.totalWaterGoal!} ml':'${widget.totalWaterGoal!-widget.waterDrunkGoal!} ml  ',
        ...
        Container(height: 4,color: ColorRes.greyColor.withOpacity(0.4),),
        SizedBox(
          height: 6.w,
        ),
        Expanded(
          child: SingleChildScrollView(
            child: Column(children: List.generate(waterCountController.items.length, (index) {
