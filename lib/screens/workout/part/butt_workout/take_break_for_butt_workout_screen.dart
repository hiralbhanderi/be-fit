...
class TakeBreakForButtWorkoutScreen extends StatelessWidget {
  static const routeName = '/TakeBreakForButtWorkoutScreen';

  TakeBreakForButtWorkoutScreen({this.exerciseNumber, this.exerciseTotalCount, this.exerciseName, this.exerciseImage});
