...
class PlanBeginnerWorkoutListScreen extends StatelessWidget {
  static const routeName = '/PlanBeginnerWorkoutListScreen';
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      '${planBeginnerController.planBeginnerModel[int.parse(dayCountForPlanBeginner!) - 1].exercise?[index].time} ${planBeginnerController.planBeginnerModel[int.parse(dayCountForPlanBeginner!) - 1].exercise?[index].workoutAllDataModel?.unit ?? ""}',
                                      style: const TextStyle(fontSize: 17, color: ColorRes.blackColor, fontWeight: FontWeight.w400),
                                    ),
                                  ],
                                ),
