...
class PlanBeginnerCompleteScreen extends StatelessWidget {
  ...
  PlanBeginnerCompleteScreen({this.dayNumberForPlanBeginner, this.exerciseTotalCountForPlanBeginner, this.kcalCountForPlanBeginner, this.durationForPlanBeginner});
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () async {
                        ...
                        Get.offNamedUntil(PlanBeginnerScreen.routeName,
