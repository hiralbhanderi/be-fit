...
class TakeBreakForPlanBeginnerScreen extends StatelessWidget {
  static const routeName = '/TakeBreakForPlanBeginnerScreen';

  TakeBreakForPlanBeginnerScreen({this.exerciseNumberForPlanBeginner, this.exerciseTotalCountForPlanBeginner, this.exerciseNameForPlanBeginner, this.exerciseImageForPlanBeginner});
                          ...
                          children: [
                            GestureDetector(
                              onTap: (){
                                ...
                                planBeginnerController.controllerForPlanBeginner.resume();
                                Get.back();
                              },
                              child: Container(
                                height: 20.w,
            ...
            Padding(
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  ...
                  Image.asset('$exerciseImageForPlanBeginner',scale: 10,)
                ],
              ),
            )
          ],
