...
class PlanBeginnerWorkoutStartScreen extends StatefulWidget {
  ...
  @override
  State<PlanBeginnerWorkoutStartScreen> createState() => _PlanBeginnerWorkoutStartScreenState();
}

class _PlanBeginnerWorkoutStartScreenState extends State<PlanBeginnerWorkoutStartScreen> {
  ...
  audioStart() async {
    if (planBeginnerController.isBGVoiceOnForPlanBeginner.value) {
      await planBeginnerController.playerForPlanBeginner!.setAsset(
        'assets/music_file/fitness_bgm.mp3',
      );
      planBeginnerController.playerForPlanBeginner!.play();
      planBeginnerController.playerForPlanBeginner!.setVolume(planBeginnerController.setAudioVolumeForPlanBeginner.value);
    }else{
      planBeginnerController.playerForPlanBeginner!.stop();
    }
  }
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        body: PageView.builder(
          itemCount: planBeginnerController.planBeginnerModel[int.parse(widget.dayCountForWorkoutStartForPlanBeginner!) - 1].exercise?.length ?? 0,
                          ...
                          CustomTimer(
                              ...
                              begin: Duration(
                                  seconds: planBeginnerController
                                          .planBeginnerModel[int.parse(widget.dayCountForWorkoutStartForPlanBeginner!) - 1].exercise?[index].time ??
                                      0),
                              // seconds: 10),
                              end: const Duration(),
                              builder: (time) {
                                            ...
                                            children: [
                                                ...
                                                children: [
                                                  ...
                                                  Expanded(
                                                    child: Obx(
                                                        ...
                                                        child: Slider(
                                                          value: planBeginnerController.audioGuideValueForPlanBeginner.value,
                                                          ...
                                                          // divisions: 5,
                                                          label: planBeginnerController.audioGuideValueForPlanBeginner.value.round().toString(),
                                                          // label: waterTotalOfUser.value.round().toString(),
                                                          onChanged: (double value) {
                                                            // setState(() {
                                                            planBeginnerController.audioGuideValueForPlanBeginner.value = value;
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  Obx(() => Switch(
                                                    onChanged: (value) {
                                                      planBeginnerController.isBGVoiceOnForPlanBeginner.value = value;
                                                    },
                                                    value: planBeginnerController.isBGVoiceOnForPlanBeginner.value,
                                                  ...
                                                  Expanded(
                                                    child: Obx(
                                                        ...
                                                        data: SliderThemeData(
                                                            trackHeight: 0.6.w, thumbShape: const RoundSliderThumbShape(enabledThumbRadius: 5)),
                                                        child: Slider(
                                                          value: planBeginnerController.bgAudioValueForPlanBeginner.value,
                                                          //value: waterTotalOfUser.value,
                                                          max: 100,
                                                          activeColor: ColorRes.greenColor.withOpacity(0.7),
                                                          inactiveColor: ColorRes.greenColor.withOpacity(0.2),
                                                          // divisions: 5,
                                                          label: planBeginnerController.bgAudioValueForPlanBeginner.value.round().toString(),
                                                          // label: waterTotalOfUser.value.round().toString(),
                                                          onChanged: (double value) {
                                                            // setState(() {
                                                            planBeginnerController.bgAudioValueForPlanBeginner.value = value;
                                                            planBeginnerController.setAudioVolumeForPlanBeginner.value =
                                                                planBeginnerController.bgAudioValueForPlanBeginner.value.round() / 100;
                                                            //waterTotalOfUser.value = value;
                                                            // });
                                                          },
                                                        ),
                                                      ...
                                                      child: ElevatedButton(
                                                        onPressed: () async {
                                                          ...
                                                          if (planBeginnerController.isBGVoiceOnForPlanBeginner.value) {
                                                            ...
                                                            planBeginnerController.playerForPlanBeginner!.play();
                                                            planBeginnerController.playerForPlanBeginner!.setVolume(planBeginnerController.setAudioVolumeForPlanBeginner.value);
                                                            print('volume value is --->>>${planBeginnerController.setAudioVolumeForPlanBeginner.value}');
                                                          }else{
                                                            planBeginnerController.playerForPlanBeginner!.stop();
                                                          }
                      ...
                      Expanded(
                        child: Column(
                          children: [
                            ...
                            Lottie.asset(
                              planBeginnerController.planBeginnerModel[int.parse(widget.dayCountForWorkoutStartForPlanBeginner!) - 1].exercise?[index]
                            ...
                            Column(
                              children: [
                                                      ...
                                                      children: [
                                                        ...
                                                        Lottie.asset(
                                                          planBeginnerController
                                                                  .planBeginnerModel[int.parse(widget.dayCountForWorkoutStartForPlanBeginner!) - 1]
                                                                  .exercise?[index]
                                                                  .workoutAllDataModel
                                                                  ?.filePath ??
                                                              '',
                                ...
                                ((planBeginnerController
                                                .planBeginnerModel[int.parse(widget.dayCountForWorkoutStartForPlanBeginner!) - 1].exercise?.length) ??
                                            0) >
                                        index + 1
                                    ? Text(
                                        ...
                                        'Next: ${planBeginnerController.planBeginnerModel[int.parse(widget.dayCountForWorkoutStartForPlanBeginner!) - 1].exercise?[index + 1].workoutAllDataModel?.name ?? ''}',
                                      ...
                                      if (planBeginnerController.isExerciseChangeIndexForPlanBeginner.value <
                                        ...
                                        Future.delayed(const Duration(seconds: 3)).then((value) {
                                          return Get.to(PlanBeginnerCompleteScreen(
                                            dayNumberForPlanBeginner: widget.dayCountForWorkoutStartForPlanBeginner,
                                            exerciseTotalCountForPlanBeginner: planBeginnerController
                                                    .planBeginnerModel[int.parse(widget.dayCountForWorkoutStartForPlanBeginner!) - 1].exercise?.length ??
                                                0,
                                            ...
                                            kcalCountForPlanBeginner: planBeginnerController
                                                .totalListOfKcalForPlanBeginner[int.parse(widget.dayCountForWorkoutStartForPlanBeginner!) - 1]
                                                .toString(),
                                            durationForPlanBeginner: planBeginnerController
                                                .timeListForPlanBeginner[int.parse(widget.dayCountForWorkoutStartForPlanBeginner!) - 1],
                                          ));
                                        });
                                      }
                                    },
