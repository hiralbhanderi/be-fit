                            ...
                            children: [
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      planIntermediateController.planIntermediateModel[int.parse(dayCountForPlanIntermediate!) - 1].exercise?[index]
                              ...
                              Image.asset(planIntermediateController.planIntermediateModel[int.parse(dayCountForPlanIntermediate!) - 1]
            ...
            child: CommonButton(
              ...
              onTap: () {
                ...
                Future.delayed(const Duration(seconds: 3)).then((value) {
                  return Get.to(PlanIntermediateWorkoutStartScreen(
                    dayCountForWorkoutStartForPlanIntermediate: dayCountForPlanIntermediate,
                  ));
                });
