...
class RestTimeForPlanIntermediateScreen extends StatelessWidget {
  static const routeName = '/RestTimeForPlanIntermediateScreen';

  RestTimeForPlanIntermediateScreen({
