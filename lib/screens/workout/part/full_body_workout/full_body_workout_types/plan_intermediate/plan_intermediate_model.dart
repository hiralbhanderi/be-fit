...
List<PlanIntermediateModel> planIntermediateModelFromJson(String str) => List<PlanIntermediateModel>.from(json.decode(str).map((x) => PlanIntermediateModel.fromJson(x)));
