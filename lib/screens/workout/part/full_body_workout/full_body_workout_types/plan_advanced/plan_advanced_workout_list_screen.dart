...
class PlanAdvancedWorkoutListScreen extends StatelessWidget {
  static const routeName = '/PlanAdvancedWorkoutListScreen';
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      '${planAdvancedController.planAdvancedModel[int.parse(dayCountForPlanAdvanced!) - 1].exercise?[index].time} ${planAdvancedController.planAdvancedModel[int.parse(dayCountForPlanAdvanced!) - 1].exercise?[index].workoutAllDataModel?.unit ?? ""}',
                                      style: const TextStyle(fontSize: 17, color: ColorRes.blackColor, fontWeight: FontWeight.w400),
                                    ),
                                  ],
                                ),
