...
class PlanAdvancedCompleteScreen extends StatelessWidget {
  ...
  PlanAdvancedCompleteScreen(
      {this.dayNumberForPlanAdvanced, this.exerciseTotalCountForPlanAdvanced, this.kcalCountForPlanAdvanced, this.durationForPlanAdvanced});
