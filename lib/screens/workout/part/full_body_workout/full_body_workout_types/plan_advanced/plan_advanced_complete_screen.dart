...
class PlanAdvancedCompleteScreen extends StatelessWidget {
  static const routeName = '/PlanAdvancedCompleteScreen';

  PlanAdvancedCompleteScreen({this.dayNumberForPlanAdvanced, this.exerciseTotalCountForPlanAdvanced, this.kcalCountForPlanAdvanced, this.durationForPlanAdvanced});

  final String? dayNumberForPlanAdvanced;
  final int? exerciseTotalCountForPlanAdvanced;
  final String? kcalCountForPlanAdvanced;
  final String? durationForPlanAdvanced;
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    GestureDetector(
                      onTap: () async {
                        nextIndexForPlanAdvancedWorkout.value = int.parse(dayNumberForPlanAdvanced ?? '0');
                        await SharedPreferencesConst.setChangeDayForPlanAdvancedWorkout(nextIndexForPlanAdvancedWorkout.value);
                        isDayChangeForPlanAdvancedWorkout.value = nextIndexForPlanAdvancedWorkout.value;
                        ...
                        Get.offNamedUntil(PlanAdvancedScreen.routeName,
