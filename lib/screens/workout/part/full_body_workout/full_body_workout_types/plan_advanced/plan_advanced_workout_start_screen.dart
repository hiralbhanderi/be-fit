...
class PlanAdvancedWorkoutStartScreen extends StatefulWidget {
  ...
  @override
  State<PlanAdvancedWorkoutStartScreen> createState() => _PlanAdvancedWorkoutStartScreenState();
}

class _PlanAdvancedWorkoutStartScreenState extends State<PlanAdvancedWorkoutStartScreen> {
  ...
  audioStart() async {
    if (planAdvancedController.isBGVoiceOnForPlanAdvanced.value) {
      await planAdvancedController.playerForPlanAdvanced!.setAsset(
        'assets/music_file/fitness_bgm.mp3',
      );
      planAdvancedController.playerForPlanAdvanced!.play();
      planAdvancedController.playerForPlanAdvanced!.setVolume(planAdvancedController.setAudioVolumeForPlanAdvanced.value);
    }else{
      planAdvancedController.playerForPlanAdvanced!.stop();
    }
  }
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        body: PageView.builder(
          itemCount: planAdvancedController.planAdvancedModel[int.parse(widget.dayCountForWorkoutStartForPlanAdvanced!) - 1].exercise?.length ?? 0,
                          ...
                          CustomTimer(
                              ...
                              begin: Duration(
                                  seconds: planAdvancedController
                                          .planAdvancedModel[int.parse(widget.dayCountForWorkoutStartForPlanAdvanced!) - 1].exercise?[index].time ??
                                      0),
                              // seconds: 10),
                              end: const Duration(),
                              builder: (time) {
                                            ...
                                            children: [
                                                ...
                                                children: [
                                                  ...
                                                  Expanded(
                                                    child: Obx(
                                                        ...
                                                        child: Slider(
                                                          value: planAdvancedController.audioGuideValueForPlanAdvanced.value,
                                                          ...
                                                          // divisions: 5,
                                                          label: planAdvancedController.audioGuideValueForPlanAdvanced.value.round().toString(),
                                                          // label: waterTotalOfUser.value.round().toString(),
                                                          onChanged: (double value) {
                                                            // setState(() {
                                                            planAdvancedController.audioGuideValueForPlanAdvanced.value = value;
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  Obx(() => Switch(
                                                    onChanged: (value) {
                                                      planAdvancedController.isBGVoiceOnForPlanAdvanced.value = value;
                                                    },
                                                    value: planAdvancedController.isBGVoiceOnForPlanAdvanced.value,
                                                  ...
                                                  Expanded(
                                                    child: Obx(
                                                        ...
                                                        data: SliderThemeData(
                                                            trackHeight: 0.6.w, thumbShape: const RoundSliderThumbShape(enabledThumbRadius: 5)),
                                                        child: Slider(
                                                          value: planAdvancedController.bgAudioValueForPlanAdvanced.value,
                                                          //value: waterTotalOfUser.value,
                                                          max: 100,
                                                          activeColor: ColorRes.greenColor.withOpacity(0.7),
                                                          inactiveColor: ColorRes.greenColor.withOpacity(0.2),
                                                          // divisions: 5,
                                                          label: planAdvancedController.bgAudioValueForPlanAdvanced.value.round().toString(),
                                                          // label: waterTotalOfUser.value.round().toString(),
                                                          onChanged: (double value) {
                                                            // setState(() {
                                                            planAdvancedController.bgAudioValueForPlanAdvanced.value = value;
                                                            planAdvancedController.setAudioVolumeForPlanAdvanced.value =
                                                                planAdvancedController.bgAudioValueForPlanAdvanced.value.round() / 100;
                                                            //waterTotalOfUser.value = value;
                                                            // });
                                                          },
                                                        ),
                                                      ...
                                                      child: ElevatedButton(
                                                        onPressed: () async {
                                                          ...
                                                          if (planAdvancedController.isBGVoiceOnForPlanAdvanced.value) {
                                                            ...
                                                            planAdvancedController.playerForPlanAdvanced!.play();
                                                            planAdvancedController.playerForPlanAdvanced!.setVolume(planAdvancedController.setAudioVolumeForPlanAdvanced.value);
                                                            print('volume value is --->>>${planAdvancedController.setAudioVolumeForPlanAdvanced.value}');
                                                          }else{
                                                            planAdvancedController.playerForPlanAdvanced!.stop();
                                                          }
                      ...
                      Expanded(
                        child: Column(
                          children: [
                            ...
                            Lottie.asset(
                              planAdvancedController.planAdvancedModel[int.parse(widget.dayCountForWorkoutStartForPlanAdvanced!) - 1].exercise?[index]
                            ...
                            Column(
                              children: [
                                                      ...
                                                      children: [
                                                        ...
                                                        Lottie.asset(
                                                          planAdvancedController
                                                                  .planAdvancedModel[int.parse(widget.dayCountForWorkoutStartForPlanAdvanced!) - 1]
                                                                  .exercise?[index]
                                                                  .workoutAllDataModel
                                                                  ?.filePath ??
                                                              '',
                                ...
                                ((planAdvancedController
                                                .planAdvancedModel[int.parse(widget.dayCountForWorkoutStartForPlanAdvanced!) - 1].exercise?.length) ??
                                            0) >
                                        index + 1
                                    ? Text(
                                        ...
                                        'Next: ${planAdvancedController.planAdvancedModel[int.parse(widget.dayCountForWorkoutStartForPlanAdvanced!) - 1].exercise?[index + 1].workoutAllDataModel?.name ?? ''}',
                                      ...
                                      if (planAdvancedController.isExerciseChangeIndexForPlanAdvanced.value <
                                        ...
                                        Future.delayed(const Duration(seconds: 3)).then((value) {
                                          return Get.to(PlanAdvancedCompleteScreen(
                                            dayNumberForPlanAdvanced: widget.dayCountForWorkoutStartForPlanAdvanced,
                                            exerciseTotalCountForPlanAdvanced: planAdvancedController
                                                    .planAdvancedModel[int.parse(widget.dayCountForWorkoutStartForPlanAdvanced!) - 1].exercise?.length ??
                                                0,
                                            kcalCountForPlanAdvanced: planAdvancedController
                                                .totalListOfKcaForPlanAdvanced[int.parse(widget.dayCountForWorkoutStartForPlanAdvanced!) - 1]
                                                .toString(),
                                            durationForPlanAdvanced: planAdvancedController
                                                .timeListForPlanAdvanced[int.parse(widget.dayCountForWorkoutStartForPlanAdvanced!) - 1],
                                          ));
                                        });
                                      }
                                    },
